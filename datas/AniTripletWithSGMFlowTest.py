...
def _make_dataset(dir, dirf):
    ...
    # print(framesPath)
    return framesPath, flowPath, framesIndex, framesFolder
...
class AniTripletWithSGMFlowTest(data.Dataset):
    def __init__(self, root, root_flow, transform=None, resizeSize=(640, 360), randomCropSize=(352, 352), train=True, shift=0):
        ...
        # frame in `root`.
        framesPath, flowPath, framesIndex, framesFolder = _make_dataset(root, root_flow)
    ...
    def __getitem__(self, index):
        ...
        if self.train:
            ...
            return sample, flow, indeces, folders
